...
class Finish:
	def __init__(self, ambient, diffuse, specular, roughness):
        ...
        def __eq__(self, other):
                return  self.ambient == self.ambient and self.diffuse == other.diffuse and self.specular == other.specular and self.roughness == other.roughness
...
class Light:
	...
	def __eq__(self, other):
                return  self.pt == self.pt and self.color == other.color
