...
def sphere_intersection_point(ray, sphere):
    ...
    C = (vector_math.dot_vector(vector_math.difference_point(ray.pt, sphere.center),vector_math.difference_point(ray.pt, sphere.center)) - sphere.rad**2)
    ...
    if t_value_0 is None: 
        if t_value_1 < 0:
            ...
            return vector_math.translate_point(ray.pt, vector_math.scale_vector(ray.dir, t_value_1))

    elif t_value_1 is None:
        if t_value_0 < 0:
            return None
        else:
            return vector_math.translate_point(ray.pt, vector_math.scale_vector(ray.dir, t_value_0))
