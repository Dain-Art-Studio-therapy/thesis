...
class Finish:
   ...
   def __eq__(self, other):
       return utility.epsilon_equal(self.ambient, other.ambient) and utility.epsilon_equal(self.diffuse, other.diffuse) and utility.epsilon_equal(self.roughness, other.roughness) and utility.epsilon_equal(self.specular, other.specular)
