...
class Sphere:
	...
	def __eq__(self, other):
		return (epsilon_equal(self.center.x, other.center.x) and
			...
			epsilon_equal(self.finish.ambient, 
				      other.finish.ambient) and
			epsilon_equal(self.finish.diffuse, 
				      other.finish.diffuse) and
			epsilon_equal(self.finish.specular, 
				      other.finish.specular) and
			epsilon_equal(self.finish.roughness, 
				      other.finish.roughness))
