...
def cast_all_rays(min_x,max_x,min_y,max_y,width,height,eye_point,sphere_list,color,light,location):
   ...
   for y in range(0,height):
      ...
      for x in range(0,width):
         ...
         print >> location, min(255,int(c.R*255)), min(255,int(c.G*255)), min(255,int(c.B*255))
