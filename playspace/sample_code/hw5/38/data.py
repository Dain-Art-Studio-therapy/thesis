...
class Ray:
  def  __init__(self,pt,dir):
    ...
    self.dir = dir
  def __eq__(self,other):
    return (Point.__eq__(self.pt, other.pt) and Vector.__eq__(self.dir, other.dir))
...
class Sphere:
  def __init__(self,center,radius, color, finish):
    ...
    self.finish = finish
  def __eq__(self,other):
    return (Point.__eq__(self.center, other.center) and utility.epsilon_equal(self.radius, other.radius)) and (Color.__eq__(self.color, other.color)) and (Finish.__eq__(self.finish, other.finish))
...
class Light:
  def __init__(self, pt, color):
      ...
      self.color = color
  def __eq__(self, other):
      return (Point.__eq__(self.pt, other.pt)) and (Color.__eq__(self.color, other.color))
