...
class Sphere:
    def __init__(self,center,radius,color,finish):
        ...
        self.finish=finish
    def __eq__(self,other):
        return(Point.__eq__(self.center,other.center) and utility.epsilon_equal(self.radius,other.radius) and self.finish==other.finish)
...
class Color:
   def __init__(self,r,g,b):
      ...
      self.b=b
   def __eq__(self,other):
       return utility.epsilon_equal(other.r,self.r) and utility.epsilon_equal(self.g,other.g) and utility.epsilon_equal(self.b,other.b)
class Finish:
