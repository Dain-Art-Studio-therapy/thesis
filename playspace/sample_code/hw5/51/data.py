...
class Sphere:
   ...
   def __eq__(self,other):
      return self.center == other.center and epsilon_equal(self.radius,other.radius) and epsilon_equal(self.color,other.color) and epsilon_equal(self.finish,other.finish)
