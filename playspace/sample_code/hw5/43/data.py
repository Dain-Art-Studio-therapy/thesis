...
class Sphere:
   ...
   def __eq__ (self,other):
      return (self.center == other.center
             ...
             and utility.epison_equal(self.finish,other.finish))
...
class Finish:
   ...
   def __eq__ (self,other):
      return (utility.epislon_equal(self.ambient,other.ambient)
             and utility.epsilon_equal(self.diffuse,other.diffuse)
             and utility.epsilon_equal(self.speculer,other.specular)
