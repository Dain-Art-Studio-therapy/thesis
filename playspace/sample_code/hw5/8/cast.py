    ...
    for y in yValues:
        for x in xValues:
            ...
            if colors:
                ...
                color_r = int(colors.r*255)
                color_g = int(colors.g*255)
                color_b = int(colors.b*255)
                color_r = colors_cap_r(color_r)
                color_g = colors_cap_g(color_g)
                color_b = colors_cap_b(color_b)


                colorstring += str(color_r) + ' ' + str(color_g) + ' ' + str(color_b)
