...
def cast_ray(ray, sphere_list, amcolor, light, eyept):
   ...
   if pts == []:
      ...
      reflec_vec = (difference_vector(Ldir_normalized, (scale_vector(Nor, d_prod * 2)))) #vector
   ...
   for yitem in ylist:
      for xitem in xlist:
         ...
         if los == Color(1.0, 1.0, 1.0):
            print >> file, 255, 255, 255
         else:
            print >> file, color_scale(los.R), color_scale(los.G), color_scale(los.B)
