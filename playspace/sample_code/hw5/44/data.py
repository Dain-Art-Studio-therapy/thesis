# Contains class definitions with __init__ funcitons
import utility
...
class Sphere:
   def __init__(self,center,radius,color,finish):
       ...
       self.finish=finish
   def __eq__(self,other):
       return self.center == other.center and self.radius == other.radius and self.color == other.color and self.finish == other.finish
...
class Finish:
   def __init__(self,ambient=0,diffuse=0,specular=0,roughness=0):
